...
const I18N = {
  ...
  en: {
    ...
    house_wallet_title:'🏦 Fund Storage',
    hw1_title:'Hardware Wallet (Ledger)',hw1_desc:'Long-term cold storage — maximum offline security',
    hw2_title:'Exchange Wallet (Binance/OKX)',hw2_desc:'Operating funds — fast withdrawal processing',
    hw3_title:'Multi-sig Wallet',hw3_desc:'2/3 signatures required — no single withdrawal possible',
  ...
  zh: {
    ...
    house_wallet_title:'🏦 本部 USDT 保管方式',
    hw1_title:'硬件钱包 (Ledger)',hw1_desc:'大规模长期存储 — 最强离线安全',
    hw2_title:'交易所钱包 (Binance/OKX)',hw2_desc:'运营资金 — 快速处理提款',
    hw3_title:'多签名钱包',hw3_desc:'需要2/3签名 — 无法单独提取',
  ...
  ja: {
    ...
    house_wallet_title:'🏦 本部 USDT 保管方法',
    hw1_title:'ハードウェアウォレット (Ledger)',hw1_desc:'大規模長期保管 — 最強オフラインセキュリティ',
    hw2_title:'取引所ウォレット (Binance/OKX)',hw2_desc:'運営資金 — 迅速な出金処理',
    hw3_title:'マルチシグウォレット',hw3_desc:'2/3署名必要 — 単独出金不可',
